...
namespace FluentValidation_Estudo.Infra.BehaviorMediatR
{
	public class ValidationRequestBehavior<TRequest, Unit> : IPipelineBehavior<TRequest, Unit> where TRequest : IValidationContext
	{
